  ...
  <div class="rev_slider" data-version="5.0">
    <ul>
      ...
      >
        ...
        <div
          class="tp-caption tp-resizeme text-white text-uppercase"
          id="rs-3-layer-1"
          data-x="['left']"
          data-hoffset="['30']"
          data-y="['middle']"
        ...
        <div
          class="tp-caption tp-resizeme text-uppercase text-white font-merry"
          id="rs-3-layer-2"
          data-x="['left']"
          data-hoffset="['30']"
          data-y="['middle']"
        ...
        >
          <span class="text-white">Providing Logistic Services </span>
        </div>
        ...
        >
          <a class="btn btn-colored btn-lg" href="#">
            Contact Now
          </a>
        </div>
      </li>
      ...
      >
        ...
        <div
          class="tp-caption tp-resizeme text-uppercase text-white "
          id="rs-1-layer-1"
          data-x="['right']"
          data-hoffset="['30']"
          data-y="['middle']"
        ...
        <div
          class="tp-caption tp-resizeme text-white font-merry  text-uppercase"
          id="rs-1-layer-2"
          data-x="['right']"
          data-hoffset="['30']"
          data-y="['middle']"
        ...
        <div
          class="tp-caption tp-resizeme text-right text-white"
          id="rs-1-layer-3"
          data-x="['right']"
          data-hoffset="['30']"
          data-y="['middle']"
      ...
      >
        ...
        <div
          class="tp-caption tp-resizeme text-uppercase font-merry"
          id="rs-3-layer-8"
          data-x="['left']"
          data-hoffset="['30']"
          data-y="['middle']"
        ...
        >
          <span class="text-white">Providing Logistics Services</span>
        </div>
